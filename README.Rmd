...
The goal of {sdtmval} is to provide a set of tools to assist statistical programmers in validating Study Data Tabulation Model (SDTM) data sets. The tools include utilities for:
 ...
 - Convert .Rmd files to .R scripts (convenience wrapper for `knitr::purl()`)

The above features are demonstrated in the example workflow shown below. These additional features each have their own vignette/article:
